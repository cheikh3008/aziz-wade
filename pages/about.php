...
<head>
    ...
    <title>Qui sommes nous | Construction</title>
                            ...
                            <div class="hero-cap pt-100">
                                ...
                                <nav aria-label="breadcrumb ">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="/#">Qui sommes nous</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
            ...
            <div class="support-wrapper align-items-end">
                <div class="left-content">
                    ...
                    <div class="section-tittle section-tittle2 mb-55">
                        ...
                        <span class="back-text">Qui sommes nous?</span>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-tittle mb-55">
                            ...
                            <span class="back-text">Partenaires</span>
                        </div>
                    </div>
                </div>
                <div class="row mx-auto">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/bollore_.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/cde.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/crbc.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/grande-cote-operations-sa.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/dangote.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/socabeg.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/total.png" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="">
                                <img src="/assets/img/sococim.png" class="img-fluid" alt="">
                            </div>
